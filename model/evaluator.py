...
import logging
import numpy as np
from RAG import augment_question_with_context
    ...
    def scoring_mcqa(self, test_dataloader: DataLoader):
        ...
        for _, batch in enumerate(test_dataloader):
            policy_preds = self.get_batch_predictions_mcqa(
                policy_model, self.reference_tokenizer, batch)
        ...
        print(all_labels, all_policy_preds)
...
class RAGModelEvaluator():
    ...
    def scoring_rag(self, test_dataloader: DataLoader):
        ...
        """
        # Ici call RAG et changer test_dataloader
        test_dataloader = augment_question_with_context(test_dataloader)
...
class QuantizedEvaluator():
    def __init__(
        ...
        self.quantized_dpo_evaluator = DPOModelEvaluator(
            ...
            reference_model_path=quantized_model_path,
    ...
    if "reward" in eval_method:
        ...
        for method in eval_method:
            if method == "rag":
                ...
                ref_model_path = main_config["reference_model_path"]
